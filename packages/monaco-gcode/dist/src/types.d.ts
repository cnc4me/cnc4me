...
export interface NamedTokenThemeRule<T extends string> extends Monaco.editor.ITokenThemeRule {
    token: T;
}
 ...
 * Type Utils
 */
export type ExtractBracketRuleTokens<T extends ReturnType<typeof createBracketRules>> = T[number]["token"];
export type ExtractLanguageRuleTokens<T extends ReturnType<typeof createLanguageRules>> = T[number][1];
