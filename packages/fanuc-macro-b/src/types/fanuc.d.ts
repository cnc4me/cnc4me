...
declare interface WhileDoExpressionCstNode extends CstNode {
...
declare type AtomicWhileExpressionCstChildren = {
  While: IToken[];
  AtomicBooleanExpression: AtomicBooleanExpressionCstNode[];
};
...
declare interface MacroNodeVisitor<IN, OUT> extends ICstVisitor<IN, OUT> {
